/**
 * Deploy IncrementalVerifiableClaim contract to Arc using Circle Smart Contract Platform SDK
 */
...
async function deployClaimContract() {
  console.log('\n🚀 Deploying IncrementalVerifiableClaim Contract to ARC-TESTNET using Circle SCP\n');
  console.log('═══════════════════════════════════════════════════════\n');
  ...
  const deployment = await scpClient.deployContract({
    ...
    description: 'NFT-like claims with incremental merkle trees for Arc hackathon',
  ...
  while (attempts < maxAttempts) {
    ...
    if (contractData?.deployStatus === 'DEPLOYED') {
      ...
      console.log('═══════════════════════════════════════════════════════\n');
      console.log(`\n🔗 View on explorer: https://testnet.arcscan.app/address/${contractData.address}\n`);
      console.log(`\n📝 Update your .env file:\nNEXT_PUBLIC_INCREMENTAL_CLAIM_CONTRACT_ADDRESS=${contractData.address}\n`);
...
deployClaimContract().catch(console.error);
